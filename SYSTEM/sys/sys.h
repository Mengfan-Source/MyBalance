...
extern float Show_Data_Mb,Show_Data_Mb2;                                    //全局显示变量，用于显示需要查看的数据
extern int Temperature;
extern u32 Distance;                                           //超声波测距
extern u8 Bi_zhang,delay_50,delay_flag,PID_Send,Flash_Send;
extern float Acceleration_Z;
extern u32 Remoter_Ch1,Remoter_Ch2;                           //航模遥控接收变量
extern float Balance_Kp,Balance_Kd,Velocity_Kp,Velocity_Ki;
extern u16 PID_Parameter[10],Flash_Parameter[10],Start_Read[2],Start_Write[2];
extern int Zhongzhi,Flag_Zhongzhi,*Start_Flash;
/////////////////////////////////////////////////////////////////  
